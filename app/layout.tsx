    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="flex flex-col 2xl:flex-row">
          <div className="bg-black border-yellow-500 border-2 box-border w-full h-[90px] 2xl:w-[160px] 2xl:h-auto">
          ...
          <div className="bg-black box-border border-yellow-500 border-2 w-full h-[90px] 2xl:w-[160px] 2xl:h-auto">
